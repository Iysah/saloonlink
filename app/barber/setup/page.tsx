...
export default function BarberSetupPage() {
  ...
  const [fullProfile, setFullProfile] = useState<TProfile | null>(null);
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setProfile({ ...profile, salon_name: e.target.value })
                    }
                    className="pl-10"
                    required
                  />
                          ...
                          {showImageUpload === service.id && (
                            <div className="border-t pt-3">
                              <p className="text-sm text-gray-600 mb-2">
                                Add up to 3 images to showcase this service
                                (optional but helps attract clients)
                              </p>
                              <div className="text-center p-4 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                                <ImageIcon className="h-8 w-8 text-gray-400 mx-auto mb-2" />
                                <p className="text-sm text-gray-600 mb-2">
                                  Image upload will be available after service
                                  creation
                                </p>
                                <p className="text-xs text-gray-500">
                                  You can add images after completing your
                                  profile setup
                                </p>
                              </div>
                            </div>
